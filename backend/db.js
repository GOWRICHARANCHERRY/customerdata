...
async function initialize() {
  await query(`
    ...
    ALTER TABLE users ADD COLUMN IF NOT EXISTS "locationRestricted" INTEGER DEFAULT 0;
    ALTER TABLE users ADD COLUMN IF NOT EXISTS "lat" DOUBLE PRECISION;
    ALTER TABLE users ADD COLUMN IF NOT EXISTS "lng" DOUBLE PRECISION;
    ALTER TABLE users ADD COLUMN IF NOT EXISTS "radius" DOUBLE PRECISION DEFAULT 500;
    ALTER TABLE users ADD COLUMN IF NOT EXISTS "screenshotRestricted" INTEGER DEFAULT 0;
